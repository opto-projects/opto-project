...
if(NOT EXISTS ${Python_ROOT_DIR})
    if(EXISTS $ENV{PythonDir})
        set(Python_ROOT_DIR $ENV{PythonDir} CACHE PATH "Path to the root directory of the Python installation" FORCE)
...
if(NOT EXISTS ${OPENCV_ROOT_DIR})
    if(EXISTS $ENV{OpenCV_Dir})
        set(OPENCV_ROOT_DIR $ENV{OpenCV_Dir} CACHE PATH "Path to the OpenCV root directory" FORCE)
...
if(NOT EXISTS ${Qt_Prefix_DIR})
    if(EXISTS $ENV{Qt5_DIR})
        set(Qt_Prefix_DIR $ENV{Qt5_DIR} CACHE PATH "Path to the Qt Directory" FORCE)
