...
#include "optodevkit/util/OriConfigDlg.h"
...
public:
    ConfigEditorFactorXY(IdsCameraConfig::FactorXY *factor, ConfigEditorFactorXY *other) : ConfigItemEditor(), factor(factor), other(other)
    {
        ...
        connect(comboX, SIGNAL(QComboBox::activated), this, SLOT(ConfigEditorFactorXY::updateOther));
        connect(comboY, SIGNAL(QComboBox::activated), this, SLOT(ConfigEditorFactorXY::updateOther));
...
void IdsCameraConfig::initDlg(ConfigDlgOpts &opts, int maxPageId)
{
