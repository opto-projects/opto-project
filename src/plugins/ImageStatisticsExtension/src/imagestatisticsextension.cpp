...
ImageStatisticsPlugin::ImageStatisticsPlugin(QObject* parent ) : Plugin(parent)
{
	type = PLUGIN_TYPE::EXTENSION;
	name = "ImageStatisticsPlugin";
	descr = "Live image statistics";
}
ImageStatisticsPlugin::~ImageStatisticsPlugin()
{
}

InterfaceBase* ImageStatisticsPlugin::getInterfaceInstance() {
	NEW_PLUGININSTANCE(ImageStatisticsExtension)
}

ImageStatisticsExtension::ImageStatisticsExtension(QObject* parent) : Extension(parent) {
