...
CameraExtensionPlugin::CameraExtensionPlugin(QObject* parent ) : Plugin(parent)
{
	type = PLUGIN_TYPE::EXTENSION;
	name = "CameraExtension";
	descr = "Live display of connected camera";
}
CameraExtensionPlugin::~CameraExtensionPlugin()
{
}

InterfaceBase* CameraExtensionPlugin::getInterfaceInstance() {
	NEW_PLUGININSTANCE(CameraExtension)
}

CameraExtension::CameraExtension(QObject* parent) : Extension(parent) {
