...
StillImageSystemSettingsDialog::StillImageSystemSettingsDialog(QWidget *parent)
	: ui(new Ui::StillImageSystemSettingsDialog) //QDialog(parent)
{
	ui->setupUi(this);
	initGui();

	qRegisterMetaType<imageParams >("imageParams");
}

StillImageSystemSettingsDialog::~StillImageSystemSettingsDialog()
{
}

void StillImageSystemSettingsDialog::setSettings(QVariantMap settings){
...
void StillImageSystemSettingsDialog::getSettings(QVariantMap* settings) {
...
void StillImageSystemSettingsDialog::initGui(){
	this->setWindowTitle(tr("Still Image System Settings"));
	connect(this->ui->pushButton_selectFile, &QPushButton::clicked, this, &StillImageSystemSettingsDialog::slot_selectFile);
	connect(this->ui->okButton, &QPushButton::clicked, this, &StillImageSystemSettingsDialog::slot_apply);
	connect(this->ui->spinBox_width, &QSpinBox::editingFinished, this, &StillImageSystemSettingsDialog::slot_checkWidthValue);
}

void StillImageSystemSettingsDialog::slot_selectFile(){
...
void StillImageSystemSettingsDialog::slot_apply() {
...
void StillImageSystemSettingsDialog::updateGui(imageParams param)
{
...
void StillImageSystemSettingsDialog::slot_enableGui(bool enable){
...
void StillImageSystemSettingsDialog::slot_checkWidthValue(){
