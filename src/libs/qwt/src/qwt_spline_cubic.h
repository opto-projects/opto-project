...
/*!
   ...
   cameraworker can be resolved by defining start/end conditions, that allow
   substituting of one of the unknowns for the start/end equations.

   Resolving the equation cameraworker is a 2 pass algorithm, requiring more CPU costs
