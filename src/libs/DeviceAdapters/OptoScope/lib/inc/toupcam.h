...
/*
    Please distinguish between camera ID (camId) and camera SN:
        (a) SN is unique and persistent, fixed inside the camera and remains unchanged, and does not change with connection or cameraworker restart.
        (b) Camera ID (camId) may change due to connection or cameraworker restart. Enumerate the cameras to get the camera ID, and then call the Open function to pass in the camId parameter to open the camera.
*/
...
/*
    get the version of this dll/so/dylib, which is: 59.28760.20250623
*/
#if defined(_WIN32)
...
#define TOUPCAM_OPTION_CDS                    0x6e       /* [RW] Correlated Double Sampling */
