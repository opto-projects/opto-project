...
struct CameraItem
{
    ...
    /// An id used to get and set a custom name for a camera, should be unique over the cameraworker.
    QString customId;
...
{
    QVariant value;
    enum { NONE,TEXT, MS, COUNT, POWER, VALUE3 } type = MS;
    bool warn = false;
};
...
Q_DECLARE_METATYPE(AnyRecord)
Q_DECLARE_METATYPE(AnyRecords)
Q_DECLARE_METATYPE(AnyRecord*)
Q_DECLARE_METATYPE(AnyRecords*)
