...
/**
 * The central dock manager that maintains the complete docking cameraworker.
 * With the configuration flags you can globally control the functionality
 * of the docking cameraworker. The dock manager uses an internal stylesheet to
...
public:
	...
	/**
	 * Sets the global configuration flags for the whole docking cameraworker.
...
Q_SIGNALS:
     ...
     * docking cameraworker but it is not deleted yet.
     */
