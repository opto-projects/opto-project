...
protected:
   ...
   * With this method we can get a handle to other devices loaded in the cameraworker,
   ...
   */
   ...
   /**
   * Gets the cameraworker ticks in microseconds.
   ...
   */
   ...
   /**
   * If this flag is set the device signals to the rest of the cameraworker that it will respond to delay settings.
   */
...
protected:
    ...
    * class always keeps track of current x,y position in user-coordinate cameraworker
