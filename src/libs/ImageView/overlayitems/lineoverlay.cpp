...
void LineOverlay::setValue(qreal start_x, qreal start_y, qreal end_x, qreal end_y)
{
	startAnchor->setPos(start_x, start_y); // Example positions
	endAnchor->setPos(end_x, end_y);
}
